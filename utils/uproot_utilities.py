...
def __make_tree_maker_event_tree(events):
    ...
    to_remove = ['lundWeightNprongs', 'lundWeightSubjetpts', 'lundWeightSubjetweights', 'lundWeightNsplittings', 'lundWeightSplittingweights', 'lundWeightLpidxs', 'lundWeightSubjetstatVars', 'lundWeightRawDistortionNoNorm', 'lundWeightStatVars', 'lundWeightPtVars', 'lundWeightStatJetUp', 'lundWeightStatJetDown', 'lundWeightJetStatVars', 'lundWeightPtJetUp', 'lundWeightPtJetDown', 'lundWeightEventStatVars', 'lundWeightJetRawDistortion', 'lundWeightNomNoNorm', 'lundWeightRawDistortion']
